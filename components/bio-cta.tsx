...
import Pictures from '@/public/images/before-after-bio.png'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-4 md:pb-20">
          ...
          <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:items-center space-y-8 md:space-y-0">
            ...
            {/* Content */}
            <div className="md:w-1/2 md:pl-10 lg:pl-20" data-aos="fade-right" data-aos-delay="100">
              <div className="text-center md:text-left">
                <h3 className="h3 font-cabinet-grotesk text-4xl mb-4">A captivating bio can put your profile among the {' '}
            ...
            {/* Creatives cards */}
            <div className="md:w-1/2 md:pl-12" data-aos-id-cards data-aos="fade-left" data-aos-delay="100">
              <div className="text-center md:text-left">
                <Image className="inline-block mb-12" src={Pictures} width={500} height={201} alt="Creatives" />
