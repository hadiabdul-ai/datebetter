                ...
                <div className="swiper-wrapper">
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4">The feedback was bit too honest for my liking haha. </h4>
                      <h4 className="h3 font-cabinet-grotesk mb-4">- Aryan Singh</h4>
                    </div>
                  </div>
                  {/* Testimonial */}
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4">The feedback was incredibly detailed.</h4>
                    </div>
                  </div>
                  {/* Testimonial */}
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4">Thanks to this amazing app! The analysis and tips were spot on, and I loved the personalized bio.</h4>
