        ...
        <div className="py-8 md:py-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between mb-12 md:mb-6">
            <div className="shrink-0 mr-4">
              {/* Logo */}
              <Link className="block group flex space-x-2" href="/" aria-label="Cruip">
                <Image className="" src={Logo} width={48} height={50} alt="Testimonial 01" />

              {/* <svg
                className="fill-gray-800 group-hover:fill-gray-600 transition duration-150 ease-in-out w-8 h-8"
                width="32"
                height="32"
              ...
              <h3 className='h4 md:h3 font-cabinet-grotesk mt-2'>DateBetter</h3>
            </Link>
            </div>
          ...
          <div className="text-center md:flex md:items-center md:justify-between mb-8 md:mb-6">
            ...
            {/* <ul className="inline-flex mb-4 md:order-2 md:ml-4 md:mb-0">
              <li>
                <a
                  className="flex justify-center items-center text-gray-800 bg-gray-100 hover:text-white hover:bg-gray-500 rounded-full transition duration-150 ease-in-out"
                  href="#0"
                  aria-label="Twitter"
                >
          ...
          <div className="text-xs text-gray-400 text-center md:text-left">
            © 2024 DateBetter. All rights reserved.
            {/* <a className="font-medium text-blue-500 decoration-blue-500 underline-offset-2 hover:underline" href="mailto:abdulhadi2122@gmail.com">
              contact us
            </a>
             */}
          </div>
